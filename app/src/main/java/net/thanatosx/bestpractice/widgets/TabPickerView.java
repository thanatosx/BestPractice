...
public class TabPickerView extends FrameLayout {
    ...
    public void show(int selectedIndex) {
        ...
        mViewWrapper.setTranslationY(-mViewWrapper.getHeight());
        mViewWrapper.animate().translationY(0).setDuration(380).setListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                super.onAnimationEnd(animation);
                mViewWrapper.setTranslationY(0);
            }
        });
    ...
    public void hide() {
        ...
        mViewWrapper.animate().translationY(-mViewWrapper.getHeight()).setDuration(380).setListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                super.onAnimationEnd(animation);
                setVisibility(GONE);
        ...
        mLayoutTop.animate().alpha(0).setDuration(380);
    }
